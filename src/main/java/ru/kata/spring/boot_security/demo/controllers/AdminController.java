...
public class AdminController {
    ...
    @Autowired
    public AdminController(UserService userService, RoleServiceImpl roleServiceImpl, UserValidate userValidate, RegistrationService registrationService) {
